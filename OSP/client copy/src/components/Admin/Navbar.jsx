...
const NavbarAdmin = () => {
  ...
  const navLinks = [
    ...
    { name: "View Applicants", path: "/admin/list-scholarships" },
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/admin" className="flex items-center gap-3">
              <img src={logo} alt="OSP Logo" className="w-10 h-10 object-contain" />
              <span className="text-xl font-bold text-slate-800 tracking-tight hidden sm:block">
                OSP <span className="text-blue-600 font-medium">Admin</span>
              </span>
            </Link>
          </div>
